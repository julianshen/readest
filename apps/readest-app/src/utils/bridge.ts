...
// `verify_update_signature` gates the custom installs (portable / AppImage /
// Android); `install_nightly_update` drives the Tauri updater for the
// platform keys it natively installs (macOS / Windows-NSIS).
